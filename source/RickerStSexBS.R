# Model name: Poisson-binomial Ricker
# Model abbreviation: PB
...
# This has a Poisson-binomial distribution. Birth and survival are together in
# the composite parameter R, so this function cannot parse out birth and density
