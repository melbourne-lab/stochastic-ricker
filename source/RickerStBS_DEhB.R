# Model name: Negative-binomial-gamma Ricker
# Model abbreviation: NBg
# Ricker with stochasticity in birth (B), survival (S), and between individual
# (ie demographic) heterogeneity in B and spatio-temporal environmental
# heterogeneity in B. Demographic stochasticity (but not sex) plus demographic
# heterogeneity (Dh) and environmental heterogeneity (Eh).
