# Model name: Negative-binomial-binomial-gamma Ricker
# Model abbreviation: NBBg
# Ricker with stochasticity in birth (B), survival (S), sex ratio, and between
# individual (ie demographic) heterogeneity in B and spatio-temporal
# environmental heterogeneity in B.
# Demographic stochasticity plus demographic heterogeneity (Dh) and
