# Model name: Negative-binomial-demographic Ricker
# Model abbreviation: NBd
# Ricker with stochasticity in birth (B), survival (S), and between individual
# (ie demographic) heterogeneity in B. Demographic stochasticity (but not sex)
# plus demographic heterogeneity (Dh).
