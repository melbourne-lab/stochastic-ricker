# Model name: Negative-binomial-environmental Ricker
# Model abbreviation: NBe
# Ricker with stochasticity in birth (B), survival (S), and between patch or
# time (ie environmental) heterogeneity in B.
...
# This results in a Negative binomial distribution with mu=Ricker, k'=k, and
# theoretical variance: Ricker + Ricker^2/(k).
# 
